...
In Seatlle, the only two trends that one can see in this graph is that the number of fatalities and number of non fatalities in car accidents stay relatively consistent year over year.
