...
```
The only two trends that one can see in this graph is that the number of fatalities and number of non fatalities in car accidents stay relatively consistent year over year.
...
```{r}
>>>>>>> 1af5d5ab849457346ab82ef9233e4242a73d3b21
...
baton_rouge_regression
```
#Trent's Analysis of Seattle data HERE
